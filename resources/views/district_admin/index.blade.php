...
@section('content')
    <div class="account-management">
        <div class="container-xl d-flex">
            <form class="management-search mt-5" action="{{ route('district_admin.index') }}" method="GET">
                <div class="row">
                        ...
                        <thead>
                            <tr>
                                <div class="row">
                                    ...
                                    <th class="column-title text-center p-0">Phường/Xã</th>
                                ...
                                <div id="deleteUserModal" class="modal fade">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <form action="{{route('district_admin.index')}}" method="POST">
                                                @csrf
